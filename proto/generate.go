...
//go:generate ${PROTOC} -I/usr/local/include -I. -I${GOPATH}/src -I${GOPATH}/src/github.com/google/protobuf/src -I${GOPATH}/src/github.com/gengo/grpc-gateway/third_party/googleapis --grpc-gateway_out=logtostderr=true:. common.proto public.proto internal.proto
